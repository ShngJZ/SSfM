...
def main():
    ...
    parser.add_argument('--compare_to_colmap', type=int, default=0)
    parser.add_argument('--benchmark_colmap', type=int, default=0)
    parser.add_argument('--split', type=str, default="scannet")
    parser.add_argument('--colmap_idx', type=int, default=0)
