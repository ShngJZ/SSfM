...
from source.utils.torch import release_cuda, initialize, to_cuda
...
class BaseTrainer(abc.ABC):
    ...
    def load_snapshot(self, checkpoint: str=None, fields=None, ignore_fields=None, additional_ignore_fields=None,
        ...
        if ignore_fields is not None:
            if 'pose_net' in ignore_fields:
                del model_dict['pose_net']
                nerf_net_dict = model_dict['nerf_net']
                del nerf_net_dict['pose_net.pose_embedding']
