...
def get_base_config():
    ...
    cfg.vis_steps = 2500  # visualize results (every N iterations)
    cfg.log_steps = 1000  # log losses and scalar states (every N iterations)
    cfg.val_steps = 5000
...
def get_nerf_default_config_llff():
    ...
    cfg.flow_ckpt_path = os.path.join(prj_root, 'checkpoint', 'PDCNet_megadepth.pth.tar')  # change
